...
namespace zone_viewer.Snoop.Forms
{
	/// <summary>
	...
	public class Parameters : System.Windows.Forms.Form
	{
      ...
      // 
      this.copyToolStripMenuItem.Image = global::zone_viewer.Properties.Resources.Copy;
      ...
      this.toolStripButton1.Image = global::zone_viewer.Properties.Resources.Print;
      ...
      this.toolStripButton2.Image = global::zone_viewer.Properties.Resources.Preview;
      ...
      this.toolStripButton3.Image = global::zone_viewer.Properties.Resources.Copy;
      ...
      this.PerformLayout();
        ...
        {                           
            ...
            zone_viewer.Snoop.Forms.ParamEnumSnoop dbox = new zone_viewer.Snoop.Forms.ParamEnumSnoop(enumMap);
            dbox.ShowDialog();                       
        }
        ...
        OnBnEnumMap(object sender, EventArgs e)
        {
            ...
            zone_viewer.Snoop.Forms.ParamEnum dbox = new zone_viewer.Snoop.Forms.ParamEnum(labelStrs, valueStrs);
            dbox.ShowDialog();
        }
