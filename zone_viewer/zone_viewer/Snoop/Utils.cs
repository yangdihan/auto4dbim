...
namespace zone_viewer.Snoop
{
   ...
   public class Utils
   {
      ...
      BrowseReflection(Object obj)
      {
         ...
         zone_viewer.Snoop.Forms.GenericPropGrid pgForm = new zone_viewer.Snoop.Forms.GenericPropGrid(obj);
      ...
      PrintMenuItemClick(PrintDialog dlg, TreeView tv)
      {
         if (tv.SelectedNode == null)
         {
            MessageBox.Show(tv.Parent, "Please select a node in the tree to print.", "zone_viewer", MessageBoxButtons.OK, MessageBoxIcon.Information);
            return;
         }
