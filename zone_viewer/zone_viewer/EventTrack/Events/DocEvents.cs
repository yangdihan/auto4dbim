...
namespace zone_viewer.EventTrack.Events {
    ...
    public class DocEvents : EventsBase {
        ...
        EnableEventsImp() {
            MessageBox.Show("Document Events Turned On ...", "zone_viewer", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        protected override void
        DisableEventsImp() {
            MessageBox.Show("Document Events Turned Off ...", "zone_viewer", MessageBoxButtons.OK, MessageBoxIcon.Information);
