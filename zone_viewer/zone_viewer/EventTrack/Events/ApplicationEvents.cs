...
namespace zone_viewer.EventTrack.Events {
    ...
    public class ApplicationEvents : EventsBase {
        ...
        EnableEventsImp() {
            MessageBox.Show("Application Events Turned On ...", "zone_viewer", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        protected override void
        DisableEventsImp() {
            MessageBox.Show("Application Events Turned Off ...", "zone_viewer", MessageBoxButtons.OK, MessageBoxIcon.Information);
